// biome-ignore-all lint/style/noNonNullAssertion: test generator
...
if (!SIGN_FUNCTION || !VALIDATE_FUNCTION)
  throw new Error("either SIGN_FUNCTION or VALIDATE_FUNCTION isn't set, required to run the test")
